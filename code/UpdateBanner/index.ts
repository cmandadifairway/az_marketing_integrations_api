...
const updateBanner: AzureFunction = async function (context: Context, req: HttpRequest): Promise<void> {
    ...
    try {
        ...
        const requestData: UpdateBannerRequest = customValidator.convertToClass(UpdateBannerRequest, req.body);
        ...
        response = await bannerService.updateBanner(requestData);
