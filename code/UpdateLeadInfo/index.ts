...
import { UpdateLeadInfoService } from "./Service/UpdateLeadInfo.service";
...
const httpTrigger: AzureFunction = async function (context: Context, req: HttpRequest): Promise<void> {
    ...
    const functionName = "UpdateLeadInfo";
    ...
    try {
        ...
        const requestData: UpdateLeadInfoRequest = customValidator.convertToClass(UpdateLeadInfoRequest, req.body);
        ...
        const updateLeadInfoService = container.get<UpdateLeadInfoService>(TYPES.UpdateLeadInfoImpl);
        response = await updateLeadInfoService.updateLeadInfo(requestData);
